...
### getDAHDIChannel
    ...
    string PAMI\Message\Event\AlarmEvent::getDAHDIChannel()

get DAHDIChannel

Returns:The channel on which the alarm occurred.
...
### getAlarm
    ...
    string PAMI\Message\Event\AlarmEvent::getAlarm()
