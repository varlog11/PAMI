PAMI\Message\Event\ConfbridgeRecordEvent
===============
...
* Class name: ConfbridgeRecordEvent
...
### getConference
    ...
    string PAMI\Message\Event\ConfbridgeRecordEvent::getConference()
...
### getBridgeUniqueid
    ...
    string PAMI\Message\Event\ConfbridgeRecordEvent::getBridgeUniqueid()
...
### getBridgeType
    ...
    string PAMI\Message\Event\ConfbridgeRecordEvent::getBridgeType()
...
### getBridgeTechnology
    ...
    string PAMI\Message\Event\ConfbridgeRecordEvent::getBridgeTechnology()
...
### getBridgeCreator
    ...
    string PAMI\Message\Event\ConfbridgeRecordEvent::getBridgeCreator()
...
### getBridgeName
    ...
    string PAMI\Message\Event\ConfbridgeRecordEvent::getBridgeName()
...
### getBridgeNumChannels
    ...
    string PAMI\Message\Event\ConfbridgeRecordEvent::getBridgeNumChannels()
...
### getBridgeVideoSourceMode
    ...
    string PAMI\Message\Event\ConfbridgeRecordEvent::getBridgeVideoSourceMode()
...
### getBridgeVideoSource
    ...
    string PAMI\Message\Event\ConfbridgeRecordEvent::getBridgeVideoSource()
