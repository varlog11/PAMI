PAMI\Message\Event\SCCPShowLinesCompleteEvent
===============

Event triggered by SCCPShowLines to signal end of response.

PHP Version 5


* Class name: SCCPShowLinesCompleteEvent
...
### getListItems
    ...
    integer PAMI\Message\Event\SCCPShowLinesCompleteEvent::getListItems()
