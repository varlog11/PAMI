PAMI\Message\Event\SCCPDeviceButtonEntryEvent
===============
...
* Class name: SCCPDeviceButtonEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPDeviceButtonEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPDeviceButtonEntryEvent::getChannelObjectType()
...
### getId
    ...
    integer PAMI\Message\Event\SCCPDeviceButtonEntryEvent::getId()
...
### getInst
    ...
    integer PAMI\Message\Event\SCCPDeviceButtonEntryEvent::getInst()
...
### getTypeStr
    ...
    string PAMI\Message\Event\SCCPDeviceButtonEntryEvent::getTypeStr()
...
### getType
    ...
    integer PAMI\Message\Event\SCCPDeviceButtonEntryEvent::getType()
...
### getPendingDelete
    ...
    boolean PAMI\Message\Event\SCCPDeviceButtonEntryEvent::getPendingDelete()
...
### getPendingUpdate
    ...
    boolean PAMI\Message\Event\SCCPDeviceButtonEntryEvent::getPendingUpdate()
...
### getDefault
    ...
    boolean PAMI\Message\Event\SCCPDeviceButtonEntryEvent::getDefault()
