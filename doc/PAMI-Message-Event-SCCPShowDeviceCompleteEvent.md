PAMI\Message\Event\SCCPShowDeviceCompleteEvent
===============

Event triggered by SCCPShowDevice to signal end of response.

PHP Version 5


* Class name: SCCPShowDeviceCompleteEvent
...
### getListItems
    ...
    integer PAMI\Message\Event\SCCPShowDeviceCompleteEvent::getListItems()
