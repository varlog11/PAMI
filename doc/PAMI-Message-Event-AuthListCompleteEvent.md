PAMI\Message\Event\AuthListCompleteEvent
===============

AuthListComplete Event
Part Of Action: PJSIPShowAuths
...
* Class name: AuthListCompleteEvent
...
### getListItems
    ...
    string PAMI\Message\Event\AuthListCompleteEvent::getListItems()
