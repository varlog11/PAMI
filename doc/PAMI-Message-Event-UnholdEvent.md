PAMI\Message\Event\UnholdEvent
===============
...
### getChannel
    ...
    string PAMI\Message\Event\UnholdEvent::getChannel()
...
### getChannelState
    ...
    string PAMI\Message\Event\UnholdEvent::getChannelState()
...
### getChannelStateDesc
    ...
    string PAMI\Message\Event\UnholdEvent::getChannelStateDesc()
...
### getCallerIDNum
    ...
    string PAMI\Message\Event\UnholdEvent::getCallerIDNum()
...
### getCallerIDName
    ...
    string PAMI\Message\Event\UnholdEvent::getCallerIDName()
...
### getConnectedLineNum
    ...
    string PAMI\Message\Event\UnholdEvent::getConnectedLineNum()
...
### getConnectedLineName
    ...
    string PAMI\Message\Event\UnholdEvent::getConnectedLineName()
...
### getLanguage
    ...
    string PAMI\Message\Event\UnholdEvent::getLanguage()
...
### getAccountCode
    ...
    string PAMI\Message\Event\UnholdEvent::getAccountCode()
...
### getContext
    ...
    string PAMI\Message\Event\UnholdEvent::getContext()
...
### getExten
    ...
    string PAMI\Message\Event\UnholdEvent::getExten()
...
### getPriority
    ...
    string PAMI\Message\Event\UnholdEvent::getPriority()
...
### getUniqueid
    ...
    string PAMI\Message\Event\UnholdEvent::getUniqueid()
...
### getLinkedid
    ...
    string PAMI\Message\Event\UnholdEvent::getLinkedid()
