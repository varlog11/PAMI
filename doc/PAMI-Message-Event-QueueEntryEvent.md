PAMI\Message\Event\QueueEntryEvent
===============
...
### getQueue
    ...
    string PAMI\Message\Event\QueueEntryEvent::getQueue()
...
### getPosition
    ...
    integer PAMI\Message\Event\QueueEntryEvent::getPosition()
...
### getChannel
    ...
    string PAMI\Message\Event\QueueEntryEvent::getChannel()
...
### getUniqueid
    ...
    integer PAMI\Message\Event\QueueEntryEvent::getUniqueid()
...
### getCallerIDNum
    ...
    integer PAMI\Message\Event\QueueEntryEvent::getCallerIDNum()
...
### getCallerIDName
    ...
    integer PAMI\Message\Event\QueueEntryEvent::getCallerIDName()
...
### getConnectedLineNum
    ...
    integer PAMI\Message\Event\QueueEntryEvent::getConnectedLineNum()
...
### getConnectedLineName
    ...
    integer PAMI\Message\Event\QueueEntryEvent::getConnectedLineName()
...
### getWait
    ...
    float PAMI\Message\Event\QueueEntryEvent::getWait()
