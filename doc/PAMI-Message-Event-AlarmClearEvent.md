PAMI\Message\Event\AlarmClearEvent
===============
...
### getDAHDIChannel
    ...
    string PAMI\Message\Event\AlarmClearEvent::getDAHDIChannel()

get DAHDIChannel

Returns:The DAHDI channel on which the alarm was cleared.
