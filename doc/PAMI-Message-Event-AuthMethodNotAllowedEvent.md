PAMI\Message\Event\AuthMethodNotAllowedEvent
===============
...
* Class name: AuthMethodNotAllowedEvent
...
### getEventTV
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getRemoteAddress()
...
### getAuthMethod
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getAuthMethod()

get AuthMethod

Returns:The authentication method attempted.
...
### getModule
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\AuthMethodNotAllowedEvent::getSessionTV()
