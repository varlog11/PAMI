PAMI\Message\Action\FilterAction
===============
...
### setOperation
    ...
    void PAMI\Message\Action\FilterAction::setOperation(string $operation)
...
### setFilter
    ...
    void PAMI\Message\Action\FilterAction::setFilter(string $filter)
...
#### Arguments
* $filter **string** - &lt;p&gt;Filters can be whitelist or blacklist&lt;/p&gt;
