...
### setFormat
    ...
    void PAMI\Message\Action\MonitorAction::setFormat(string $format)
...
#### Arguments
* $format **string** - &lt;p&gt;Format to be used during recording&lt;/p&gt;



### setMix

    void PAMI\Message\Action\MonitorAction::setMix($mix)
