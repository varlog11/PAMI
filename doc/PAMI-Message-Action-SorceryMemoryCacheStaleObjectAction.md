...
* Class name: SorceryMemoryCacheStaleObjectAction
...
### setReload
    ...
    void PAMI\Message\Action\SorceryMemoryCacheStaleObjectAction::setReload(string $reload)
...
#### Arguments
* $reload **string** - &lt;p&gt;If true, then immediately reload the object from the backend cache instead of waiting for the next retrieval&lt;/p&gt;
