...
### getObjectType
    ...
    string PAMI\Message\Event\AorDetailEvent::getObjectType()
...
### getObjectName
    ...
    string PAMI\Message\Event\AorDetailEvent::getObjectName()
...
### getMinimumExpiration
    ...
    string PAMI\Message\Event\AorDetailEvent::getMinimumExpiration()
...
### getMaximumExpiration
    ...
    string PAMI\Message\Event\AorDetailEvent::getMaximumExpiration()
...
### getDefaultExpiration
    ...
    string PAMI\Message\Event\AorDetailEvent::getDefaultExpiration()
...
### getQualifyFrequency
    ...
    string PAMI\Message\Event\AorDetailEvent::getQualifyFrequency()
...
### getAuthenticateQualify
    ...
    string PAMI\Message\Event\AorDetailEvent::getAuthenticateQualify()
...
### getMaxContacts
    ...
    string PAMI\Message\Event\AorDetailEvent::getMaxContacts()
...
### getRemoveExisting
    ...
    string PAMI\Message\Event\AorDetailEvent::getRemoveExisting()
...
### getMailboxes
    ...
    string PAMI\Message\Event\AorDetailEvent::getMailboxes()
...
### getOutboundProxy
    ...
    string PAMI\Message\Event\AorDetailEvent::getOutboundProxy()
...
### getSupportPath
    ...
    string PAMI\Message\Event\AorDetailEvent::getSupportPath()
...
### getTotalContacts
    ...
    string PAMI\Message\Event\AorDetailEvent::getTotalContacts()
...
### getContactsRegistered
    ...
    string PAMI\Message\Event\AorDetailEvent::getContactsRegistered()
...
### getEndpointName
    ...
    string PAMI\Message\Event\AorDetailEvent::getEndpointName()
...
### getContact
    ...
    string PAMI\Message\Event\AorDetailEvent::getContact()
...
### getContacts
    ...
    string PAMI\Message\Event\AorDetailEvent::getContacts()
