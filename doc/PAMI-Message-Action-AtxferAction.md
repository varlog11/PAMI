PAMI\Message\Action\AtxferAction
===============
...
### setContext
    ...
    void PAMI\Message\Action\AtxferAction::setContext(string $context)
...
#### Arguments
* $context **string** - &lt;p&gt;Context to transfer to.&lt;/p&gt;
