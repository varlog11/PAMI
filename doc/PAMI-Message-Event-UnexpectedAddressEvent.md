PAMI\Message\Event\UnexpectedAddressEvent
===============
...
* Class name: UnexpectedAddressEvent
...
### getEventTV
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getRemoteAddress()
...
### getExpectedAddress
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getExpectedAddress()

get ExpectedAddress

Returns:The address that the request was expected to use.
...
### getModule
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\UnexpectedAddressEvent::getSessionTV()
