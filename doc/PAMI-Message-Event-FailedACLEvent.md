PAMI\Message\Event\FailedACLEvent
===============
...
### getEventTV
    ...
    string PAMI\Message\Event\FailedACLEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\FailedACLEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\FailedACLEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\FailedACLEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\FailedACLEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\FailedACLEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\FailedACLEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\FailedACLEvent::getRemoteAddress()
...
### getModule
    ...
    string PAMI\Message\Event\FailedACLEvent::getModule()
...
### getACLName
    ...
    string PAMI\Message\Event\FailedACLEvent::getACLName()

get ACLName

Returns:If available, the name of the ACL that failed.
...
### getSessionTV
    ...
    string PAMI\Message\Event\FailedACLEvent::getSessionTV()
