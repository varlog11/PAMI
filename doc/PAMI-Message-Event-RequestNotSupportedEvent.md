PAMI\Message\Event\RequestNotSupportedEvent
===============
...
* Class name: RequestNotSupportedEvent
...
### getEventTV
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getRemoteAddress()
...
### getRequestType
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getRequestType()
...
### getModule
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\RequestNotSupportedEvent::getSessionTV()
