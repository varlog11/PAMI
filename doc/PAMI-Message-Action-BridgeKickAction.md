PAMI\Message\Action\BridgeKickAction
===============
...
### setBridgeUniqueid
    ...
    void PAMI\Message\Action\BridgeKickAction::setBridgeUniqueid(string $bridgeuniqueid)
...
#### Arguments
* $bridgeuniqueid **string** - &lt;p&gt;The unique ID of the bridge containing the channel to destroy. This parameter can be omitted, or supplied to insure that the channel is not removed from the wrong bridge.&lt;/p&gt;
