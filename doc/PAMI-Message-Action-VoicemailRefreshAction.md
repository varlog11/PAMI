PAMI\Message\Action\VoicemailRefreshAction
===============
...
* Class name: VoicemailRefreshAction
...
### setContext
    ...
    void PAMI\Message\Action\VoicemailRefreshAction::setContext(string $context)
...
### setMailbox
    ...
    void PAMI\Message\Action\VoicemailRefreshAction::setMailbox(string $mailbox)
