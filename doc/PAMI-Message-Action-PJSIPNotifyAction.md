PAMI\Message\Action\PJSIPNotifyAction
===============
...
### setEndpoint
    ...
    void PAMI\Message\Action\PJSIPNotifyAction::setEndpoint(string $endpoint)
...
#### Arguments
* $endpoint **string** - &lt;p&gt;The endpoint to which to send the NOTIFY.&lt;/p&gt;



### setURI

    void PAMI\Message\Action\PJSIPNotifyAction::setURI(string $uri)
...
#### Arguments
* $uri **string** - &lt;p&gt;Abritrary URI to which to send the NOTIFY.&lt;/p&gt;



### setchannel

    void PAMI\Message\Action\PJSIPNotifyAction::setchannel(string $channel)
...
#### Arguments
* $channel **string** - &lt;p&gt;Channel name to send the NOTIFY. Must be a PJSIP channel.&lt;/p&gt;
