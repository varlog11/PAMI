PAMI\Message\Event\ShutdownEvent
===============
...
### getShutdown
    ...
    string PAMI\Message\Event\ShutdownEvent::getShutdown()
...
### getRestart
    ...
    string PAMI\Message\Event\ShutdownEvent::getRestart()
