PAMI\Message\Event\MWIGetCompleteEvent
===============
...
* Class name: MWIGetCompleteEvent
...
### getListItems
    ...
    string PAMI\Message\Event\MWIGetCompleteEvent::getListItems()

get ListItems

Returns:The number of mailboxes reported.
