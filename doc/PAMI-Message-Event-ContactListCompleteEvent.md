PAMI\Message\Event\ContactListCompleteEvent
===============

ContactListComplete Event
Part Of Action: PJSIPShowContacts
...
* Class name: ContactListCompleteEvent
...
### getListItems
    ...
    string PAMI\Message\Event\ContactListCompleteEvent::getListItems()
