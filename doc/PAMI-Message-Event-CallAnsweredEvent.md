PAMI\Message\Event\CallAnsweredEvent
===============
...
### getChannel
    ...
    string PAMI\Message\Event\CallAnsweredEvent::getChannel()
...
### getSCCPLine
    ...
    string PAMI\Message\Event\CallAnsweredEvent::getSCCPLine()
...
### getSCCPDevice
    ...
    string PAMI\Message\Event\CallAnsweredEvent::getSCCPDevice()
...
### getUniqueid
    ...
    string PAMI\Message\Event\CallAnsweredEvent::getUniqueid()
...
### getCallingPartyNumber
    ...
    string PAMI\Message\Event\CallAnsweredEvent::getCallingPartyNumber()
...
### getCallingPartyName
    ...
    string PAMI\Message\Event\CallAnsweredEvent::getCallingPartyName()
...
### getoriginalCallingParty

    string PAMI\Message\Event\CallAnsweredEvent::getoriginalCallingParty()
...
### getlastRedirectingParty

    string PAMI\Message\Event\CallAnsweredEvent::getlastRedirectingParty()
