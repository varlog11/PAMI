PAMI\Message\Event\ConfbridgeStopRecordEvent
===============
...
* Class name: ConfbridgeStopRecordEvent
...
### getConference
    ...
    string PAMI\Message\Event\ConfbridgeStopRecordEvent::getConference()

get Conference

Returns:The name of the Confbridge conference.
...
### getBridgeUniqueid
    ...
    string PAMI\Message\Event\ConfbridgeStopRecordEvent::getBridgeUniqueid()
...
### getBridgeType
    ...
    string PAMI\Message\Event\ConfbridgeStopRecordEvent::getBridgeType()
...
### getBridgeTechnology
    ...
    string PAMI\Message\Event\ConfbridgeStopRecordEvent::getBridgeTechnology()
...
### getBridgeCreator
    ...
    string PAMI\Message\Event\ConfbridgeStopRecordEvent::getBridgeCreator()
...
### getBridgeName
    ...
    string PAMI\Message\Event\ConfbridgeStopRecordEvent::getBridgeName()
...
### getBridgeNumChannels
    ...
    string PAMI\Message\Event\ConfbridgeStopRecordEvent::getBridgeNumChannels()
...
### getBridgeVideoSourceMode
    ...
    string PAMI\Message\Event\ConfbridgeStopRecordEvent::getBridgeVideoSourceMode()
...
### getBridgeVideoSource
    ...
    string PAMI\Message\Event\ConfbridgeStopRecordEvent::getBridgeVideoSource()
