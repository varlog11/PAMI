PAMI\Message\Event\TableStartEvent
===============

Event triggered when an &#039;TableStart&#039; Event comes in.

PHP Version 5


* Class name: TableStartEvent
...
### getTableName
    ...
    string PAMI\Message\Event\TableStartEvent::getTableName()
