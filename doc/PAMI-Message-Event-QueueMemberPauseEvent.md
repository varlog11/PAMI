PAMI\Message\Event\QueueMemberPauseEvent
===============
...
* Class name: QueueMemberPauseEvent
...
### getQueue
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getQueue()
...
### getMemberName
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getMemberName()
...
### getInterface
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getInterface()
...
### getStateInterface
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getStateInterface()
...
### getMembership
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getMembership()
...
### getPenalty
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getPenalty()
...
### getCallsTaken
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getCallsTaken()
...
### getLastCall
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getLastCall()
...
### getLastPause
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getLastPause()
...
### getInCall
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getInCall()
...
### getStatus
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getStatus()
...
### getPaused
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getPaused()
...
### getPausedReason
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getPausedReason()
...
### getRinginuse
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getRinginuse()
...
### getWrapuptime
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getWrapuptime()
...
### getReason
    ...
    string PAMI\Message\Event\QueueMemberPauseEvent::getReason()
