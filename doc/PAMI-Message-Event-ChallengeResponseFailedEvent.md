PAMI\Message\Event\ChallengeResponseFailedEvent
===============
...
* Class name: ChallengeResponseFailedEvent
...
### getEventTV
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getRemoteAddress()
...
### getChallenge
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getChallenge()

get Challenge

Returns:The challenge that was sent.
...
### getResponse
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getResponse()
...
### getExpectedResponse
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getExpectedResponse()

get ExpectedResponse

Returns:The expected response to the challenge.
...
### getModule
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\ChallengeResponseFailedEvent::getSessionTV()
