PAMI\Message\Event\InvalidTransportEvent
===============
...
* Class name: InvalidTransportEvent
...
### getEventTV
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getRemoteAddress()
...
### getAttemptedTransport

    string PAMI\Message\Event\InvalidTransportEvent::getAttemptedTransport()

get AttemptedTransport

Returns:The transport type that the request attempted to use.
...
### getModule
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\InvalidTransportEvent::getSessionTV()
