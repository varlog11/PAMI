PAMI\Message\Event\QueueMemberRinginuseEvent
===============
...
* Class name: QueueMemberRinginuseEvent
...
### getQueue
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getQueue()
...
### getMemberName
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getMemberName()
...
### getInterface
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getInterface()
...
### getStateInterface
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getStateInterface()
...
### getMembership
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getMembership()
...
### getPenalty
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getPenalty()
...
### getCallsTaken
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getCallsTaken()
...
### getLastCall
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getLastCall()
...
### getLastPause
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getLastPause()
...
### getInCall
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getInCall()
...
### getStatus
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getStatus()
...
### getPaused
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getPaused()
...
### getPausedReason
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getPausedReason()
...
### getRinginuse
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getRinginuse()
...
### getWrapuptime
    ...
    string PAMI\Message\Event\QueueMemberRinginuseEvent::getWrapuptime()
