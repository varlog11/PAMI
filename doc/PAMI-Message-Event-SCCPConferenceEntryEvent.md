PAMI\Message\Event\SCCPConferenceEntryEvent
===============
...
* Class name: SCCPConferenceEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPConferenceEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPConferenceEntryEvent::getChannelObjectType()
...
### getId
    ...
    integer PAMI\Message\Event\SCCPConferenceEntryEvent::getId()
...
### getParticipants
    ...
    integer PAMI\Message\Event\SCCPConferenceEntryEvent::getParticipants()
...
### getModerators
    ...
    integer PAMI\Message\Event\SCCPConferenceEntryEvent::getModerators()
...
### getAnnounce
    ...
    boolean PAMI\Message\Event\SCCPConferenceEntryEvent::getAnnounce()
...
### getMuteOnEntry
    ...
    boolean PAMI\Message\Event\SCCPConferenceEntryEvent::getMuteOnEntry()
