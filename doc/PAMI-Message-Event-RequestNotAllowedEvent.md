PAMI\Message\Event\RequestNotAllowedEvent
===============
...
* Class name: RequestNotAllowedEvent
...
### getEventTV
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getRemoteAddress()
...
### getRequestType
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getRequestType()
...
### getModule
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getSessionTV()
...
### getRequestParams
    ...
    string PAMI\Message\Event\RequestNotAllowedEvent::getRequestParams()

get RequestParams

Returns:Parameters provided to the rejected request.
