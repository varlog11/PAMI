PAMI\Message\Event\SCCPDeviceFeatureEntryEvent
===============

Event triggered by SCCPShowDevice Feature Entries.

PHP Version 5


* Class name: SCCPDeviceFeatureEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPDeviceFeatureEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPDeviceFeatureEntryEvent::getChannelObjectType()
...
### getId
    ...
    integer PAMI\Message\Event\SCCPDeviceFeatureEntryEvent::getId()
...
### getOptions
    ...
    string PAMI\Message\Event\SCCPDeviceFeatureEntryEvent::getOptions()
...
### getStatus
    ...
    integer PAMI\Message\Event\SCCPDeviceFeatureEntryEvent::getStatus()
