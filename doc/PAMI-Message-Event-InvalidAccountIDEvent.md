PAMI\Message\Event\InvalidAccountIDEvent
===============
...
* Class name: InvalidAccountIDEvent
...
### getEventTV
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getRemoteAddress()
...
### getModule
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\InvalidAccountIDEvent::getSessionTV()
