PAMI\Message\Event\SCCPDeviceEntryEvent
===============
...
* Class name: SCCPDeviceEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPDeviceEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPDeviceEntryEvent::getChannelObjectType()
...
### getDescription
    ...
    string PAMI\Message\Event\SCCPDeviceEntryEvent::getDescription()
...
### getAddress
    ...
    string PAMI\Message\Event\SCCPDeviceEntryEvent::getAddress()
...
### getMac
    ...
    string PAMI\Message\Event\SCCPDeviceEntryEvent::getMac()
...
### getRegState
    ...
    string PAMI\Message\Event\SCCPDeviceEntryEvent::getRegState()
...
### getToken
    ...
    string PAMI\Message\Event\SCCPDeviceEntryEvent::getToken()
...
### getRegTime
    ...
    string PAMI\Message\Event\SCCPDeviceEntryEvent::getRegTime()
...
### getActive
    ...
    boolean PAMI\Message\Event\SCCPDeviceEntryEvent::getActive()
...
### getLines
    ...
    integer PAMI\Message\Event\SCCPDeviceEntryEvent::getLines()
...
### getNat
    ...
    string PAMI\Message\Event\SCCPDeviceEntryEvent::getNat()
