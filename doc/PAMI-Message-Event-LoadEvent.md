...
### getModule
    ...
    string PAMI\Message\Event\LoadEvent::getModule()

get Module

Returns:The name of the module that was loaded
...
### getStatus
    ...
    string PAMI\Message\Event\LoadEvent::getStatus()
