PAMI\Message\Event\FAXSessionsCompleteEvent
===============
...
* Class name: FAXSessionsCompleteEvent
...
### getTotal
    ...
    string PAMI\Message\Event\FAXSessionsCompleteEvent::getTotal()

get Total

Returns:Count of FAXSession events sent in response to FAXSessions action
