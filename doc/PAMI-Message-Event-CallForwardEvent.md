PAMI\Message\Event\CallForwardEvent
===============
...
### getChannelType
    ...
    string PAMI\Message\Event\CallForwardEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\CallForwardEvent::getChannelObjectType()
...
### getFeature
    ...
    string PAMI\Message\Event\CallForwardEvent::getFeature()
...
### getStatus
    ...
    boolean PAMI\Message\Event\CallForwardEvent::getStatus()
...
### getExtension
    ...
    string PAMI\Message\Event\CallForwardEvent::getExtension()
...
### getSCCPLine
    ...
    string PAMI\Message\Event\CallForwardEvent::getSCCPLine()
...
### getSCCPDevice
    ...
    string PAMI\Message\Event\CallForwardEvent::getSCCPDevice()
