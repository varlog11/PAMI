PAMI\Message\Event\InvalidPasswordEvent
===============
...
* Class name: InvalidPasswordEvent
...
### getEventTV
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getRemoteAddress()
...
### getModule
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getSessionTV()
...
### getChallenge
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getChallenge()
...
### getReceivedChallenge

    string PAMI\Message\Event\InvalidPasswordEvent::getReceivedChallenge()

get ReceivedChallenge

Returns:The challenge that was received.
...
### getReceivedHash
    ...
    string PAMI\Message\Event\InvalidPasswordEvent::getReceivedHash()

get ReceivedHash

Returns:The hash that was received.
