PAMI\Message\Event\SCCPShowSessionsCompleteEvent
===============

Event triggered by SCCPShowSessions to signal end of response.

PHP Version 5


* Class name: SCCPShowSessionsCompleteEvent
...
### getListItems
    ...
    integer PAMI\Message\Event\SCCPShowSessionsCompleteEvent::getListItems()
