PAMI\Message\Event\SCCPMailboxSubscriberEntryEvent
===============
...
* Class name: SCCPMailboxSubscriberEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPMailboxSubscriberEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPMailboxSubscriberEntryEvent::getChannelObjectType()
...
### getMailbox
    ...
    string PAMI\Message\Event\SCCPMailboxSubscriberEntryEvent::getMailbox()
...
### getLineName
    ...
    string PAMI\Message\Event\SCCPMailboxSubscriberEntryEvent::getLineName()
...
### getContext
    ...
    string PAMI\Message\Event\SCCPMailboxSubscriberEntryEvent::getContext()
...
### getNew
    ...
    integer PAMI\Message\Event\SCCPMailboxSubscriberEntryEvent::getNew()
...
### getOld
    ...
    integer PAMI\Message\Event\SCCPMailboxSubscriberEntryEvent::getOld()
...
### getSub
    ...
    boolean PAMI\Message\Event\SCCPMailboxSubscriberEntryEvent::getSub()
