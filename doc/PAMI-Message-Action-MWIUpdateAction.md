PAMI\Message\Action\MWIUpdateAction
===============
...
### setOldMessages
    ...
    void PAMI\Message\Action\MWIUpdateAction::setOldMessages(string $oldmessages)
...
#### Arguments
* $oldmessages **string** - &lt;p&gt;The number of old messages in the mailbox. Defaults to zero if missing.&lt;/p&gt;



### setNewMessages

    void PAMI\Message\Action\MWIUpdateAction::setNewMessages(string $newmessages)
...
#### Arguments
* $newmessages **string** - &lt;p&gt;The number of new messages in the mailbox. Defaults to zero if missing.&lt;/p&gt;
