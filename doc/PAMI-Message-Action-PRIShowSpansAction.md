PAMI\Message\Action\PRIShowSpansAction
===============
...
### setSpan
    ...
    void PAMI\Message\Action\PRIShowSpansAction::setSpan(string $span)
...
#### Arguments
* $span **string** - &lt;p&gt;Specify the specific span to show. Show all spans if zero or not present.&lt;/p&gt;
