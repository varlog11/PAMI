PAMI\Message\Action\QueueMemberRingInUseAction
===============
...
* Class name: QueueMemberRingInUseAction
...
### setQueue
    ...
    void PAMI\Message\Action\QueueMemberRingInUseAction::setQueue(string $queue)
