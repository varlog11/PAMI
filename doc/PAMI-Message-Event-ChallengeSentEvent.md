PAMI\Message\Event\ChallengeSentEvent
===============
...
### getEventTV
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getRemoteAddress()
...
### getChallenge
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getChallenge()
...
### getModule
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\ChallengeSentEvent::getSessionTV()
