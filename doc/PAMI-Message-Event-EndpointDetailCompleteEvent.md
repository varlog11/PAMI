PAMI\Message\Event\EndpointDetailCompleteEvent
===============

EndpointDetailComplete Event
Part Of Action: PJSIPShowEndpoint
...
* Class name: EndpointDetailCompleteEvent
...
### getListItems
    ...
    string PAMI\Message\Event\EndpointDetailCompleteEvent::getListItems()
