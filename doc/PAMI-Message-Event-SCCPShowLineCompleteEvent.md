PAMI\Message\Event\SCCPShowLineCompleteEvent
===============

Event triggered by SCCPShowLine to signal end of response.

PHP Version 5


* Class name: SCCPShowLineCompleteEvent
...
### getListItems
    ...
    integer PAMI\Message\Event\SCCPShowLineCompleteEvent::getListItems()
