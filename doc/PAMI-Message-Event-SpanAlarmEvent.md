PAMI\Message\Event\SpanAlarmEvent
===============
...
### getSpan
    ...
    string PAMI\Message\Event\SpanAlarmEvent::getSpan()
...
### getAlarm
    ...
    string PAMI\Message\Event\SpanAlarmEvent::getAlarm()
