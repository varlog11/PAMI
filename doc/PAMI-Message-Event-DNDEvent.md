...
### getChannelType
    ...
    string PAMI\Message\Event\DNDEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\DNDEvent::getChannelObjectType()
...
### getFeature
    ...
    string PAMI\Message\Event\DNDEvent::getFeature()
...
### getStatus
    ...
    string PAMI\Message\Event\DNDEvent::getStatus()
...
### getSCCPDevice
    ...
    string PAMI\Message\Event\DNDEvent::getSCCPDevice()
