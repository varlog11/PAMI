PAMI\Message\Event\SCCPShowDevicesCompleteEvent
===============

Event triggered by SCCPShowDevices to signal end of response.

PHP Version 5


* Class name: SCCPShowDevicesCompleteEvent
...
### getListItems
    ...
    integer PAMI\Message\Event\SCCPShowDevicesCompleteEvent::getListItems()
