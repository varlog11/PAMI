PAMI\Message\Event\SCCPDeviceSpeeddialEntryEvent
===============

Event triggered by SCCPShowDevice SpeedDial Entries.

PHP Version 5


* Class name: SCCPDeviceSpeeddialEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPDeviceSpeeddialEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPDeviceSpeeddialEntryEvent::getChannelObjectType()
...
### getId
    ...
    integer PAMI\Message\Event\SCCPDeviceSpeeddialEntryEvent::getId()
...
### getNumber
    ...
    string PAMI\Message\Event\SCCPDeviceSpeeddialEntryEvent::getNumber()
...
### getHint
    ...
    string PAMI\Message\Event\SCCPDeviceSpeeddialEntryEvent::getHint()
