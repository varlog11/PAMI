PAMI\Message\Event\SCCPShowConferencesCompleteEvent
===============
...
* Class name: SCCPShowConferencesCompleteEvent
...
### getListItems
    ...
    integer PAMI\Message\Event\SCCPShowConferencesCompleteEvent::getListItems()
