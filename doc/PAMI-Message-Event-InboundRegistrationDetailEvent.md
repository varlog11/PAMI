PAMI\Message\Event\InboundRegistrationDetailEvent
===============
...
* Class name: InboundRegistrationDetailEvent
...
### getObjectType
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getObjectType()
...
### getObjectName
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getObjectName()
...
### getMinimumExpiration
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getMinimumExpiration()
...
### getMaximumExpiration

    string PAMI\Message\Event\InboundRegistrationDetailEvent::getMaximumExpiration()
...
### getDefaultExpiration
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getDefaultExpiration()
...
### getQualifyFrequency
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getQualifyFrequency()
...
### getAuthenticateQualify
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getAuthenticateQualify()
...
### getMaxContacts
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getMaxContacts()
...
### getRemoveExisting
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getRemoveExisting()
...
### getMailboxes
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getMailboxes()
...
### getOutboundProxy
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getOutboundProxy()
...
### getSupportPath
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getSupportPath()
...
### getTotalContacts
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getTotalContacts()
...
### getContactsRegistered

    string PAMI\Message\Event\InboundRegistrationDetailEvent::getContactsRegistered()
...
### getEndpointName
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getEndpointName()
...
### getContact
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getContact()
...
### getContacts
    ...
    string PAMI\Message\Event\InboundRegistrationDetailEvent::getContacts()
