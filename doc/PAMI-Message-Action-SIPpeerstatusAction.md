PAMI\Message\Action\SIPpeerstatusAction
===============
...
* Class name: SIPpeerstatusAction
...
### setPeer
    ...
    void PAMI\Message\Action\SIPpeerstatusAction::setPeer(string $peer)
...
#### Arguments
* $peer **string** - &lt;p&gt;The peer name you want to check.&lt;/p&gt;
