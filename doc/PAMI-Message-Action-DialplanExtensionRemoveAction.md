PAMI\Message\Action\DialplanExtensionRemoveAction
===============
...
* Class name: DialplanExtensionRemoveAction
...
### setPriority
    ...
    void PAMI\Message\Action\DialplanExtensionRemoveAction::setPriority(string $priority)
...
#### Arguments
* $priority **string** - &lt;p&gt;If provided, only remove this priority from the extension instead of all priorities in the extension.&lt;/p&gt;
