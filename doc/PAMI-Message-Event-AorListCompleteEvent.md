PAMI\Message\Event\AorListCompleteEvent
===============

AorListComplete Event
Part Of Action: PJSIPShowAors
...
* Class name: AorListCompleteEvent
...
### getListItems
    ...
    string PAMI\Message\Event\AorListCompleteEvent::getListItems()
