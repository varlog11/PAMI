PAMI\Message\Event\SCCPDeviceLineEntryEvent
===============
...
* Class name: SCCPDeviceLineEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPDeviceLineEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPDeviceLineEntryEvent::getChannelObjectType()
...
### getId
    ...
    integer PAMI\Message\Event\SCCPDeviceLineEntryEvent::getId()
...
### getSuffix
    ...
    integer PAMI\Message\Event\SCCPDeviceLineEntryEvent::getSuffix()
...
### getLabel
    ...
    string PAMI\Message\Event\SCCPDeviceLineEntryEvent::getLabel()
...
### getCfwdType
    ...
    string PAMI\Message\Event\SCCPDeviceLineEntryEvent::getCfwdType()
...
### getCfwdNumber
    ...
    string PAMI\Message\Event\SCCPDeviceLineEntryEvent::getCfwdNumber()
