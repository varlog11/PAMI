PAMI\Message\Event\LoadAverageLimitEvent
===============
...
* Class name: LoadAverageLimitEvent
...
### getEventTV
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getEventTV()
...
### getSeverity
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getSeverity()
...
### getService
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getService()
...
### getEventVersion
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getEventVersion()
...
### getAccountID
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getAccountID()
...
### getSessionID
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getSessionID()
...
### getLocalAddress
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getLocalAddress()
...
### getRemoteAddress
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getRemoteAddress()
...
### getModule
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getModule()
...
### getSessionTV
    ...
    string PAMI\Message\Event\LoadAverageLimitEvent::getSessionTV()
