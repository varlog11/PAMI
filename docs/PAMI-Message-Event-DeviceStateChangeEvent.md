...
* Class name: DeviceStateChangeEvent
...
### getPrivilege
    ...
    string PAMI\Message\Event\DeviceStateChangeEvent::getPrivilege()
...
### getDevice
    ...
    string PAMI\Message\Event\DeviceStateChangeEvent::getDevice()
...
### getState
    ...
    string PAMI\Message\Event\DeviceStateChangeEvent::getState()
