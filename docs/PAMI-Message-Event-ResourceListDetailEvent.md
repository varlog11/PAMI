...
* Class name: ResourceListDetailEvent
...
### getObjectType
    ...
    string PAMI\Message\Event\ResourceListDetailEvent::getObjectType()
...
### getObjectName
    ...
    string PAMI\Message\Event\ResourceListDetailEvent::getObjectName()
