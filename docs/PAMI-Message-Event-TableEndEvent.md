PAMI\Message\Event\TableEndEvent
===============

Event triggered when an &#039;TableEnd&#039; Event comes in.

PHP Version 5


* Class name: TableEndEvent
...
### getTableName
    ...
    string PAMI\Message\Event\TableEndEvent::getTableName()
