PAMI\Message\Event\DAHDIChannelEvent
===============
...
### getPrivilege
    ...
    string PAMI\Message\Event\DAHDIChannelEvent::getPrivilege()
...
### getDAHDIChannel
    ...
    string PAMI\Message\Event\DAHDIChannelEvent::getDAHDIChannel()
...
### getDAHDISpan
    ...
    string PAMI\Message\Event\DAHDIChannelEvent::getDAHDISpan()
...
### getChannel
    ...
    string PAMI\Message\Event\DAHDIChannelEvent::getChannel()
...
### getUniqueID
    ...
    string PAMI\Message\Event\DAHDIChannelEvent::getUniqueID()
