PAMI\Message\Event\SCCPConfStartEvent
===============
...
### getConfId
    ...
    integer PAMI\Message\Event\SCCPConfStartEvent::getConfId()
...
### getSCCPDevice
    ...
    string PAMI\Message\Event\SCCPConfStartEvent::getSCCPDevice()
