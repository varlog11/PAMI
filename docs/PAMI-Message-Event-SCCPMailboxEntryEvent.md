PAMI\Message\Event\SCCPMailboxEntryEvent
===============

Event triggered by SCCPShowLine Mailbox Entries.

PHP Version 5


* Class name: SCCPMailboxEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPMailboxEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPMailboxEntryEvent::getChannelObjectType()
...
### getMailbox
    ...
    string PAMI\Message\Event\SCCPMailboxEntryEvent::getMailbox()
...
### getContext
    ...
    string PAMI\Message\Event\SCCPMailboxEntryEvent::getContext()
