PAMI\Message\Event\SCCPAttachedDeviceEntryEvent
===============
...
* Class name: SCCPAttachedDeviceEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPAttachedDeviceEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPAttachedDeviceEntryEvent::getChannelObjectType()
...
### getDeviceName
    ...
    string PAMI\Message\Event\SCCPAttachedDeviceEntryEvent::getDeviceName()
...
### getCfwdType
    ...
    string PAMI\Message\Event\SCCPAttachedDeviceEntryEvent::getCfwdType()
...
### getCfwdNumber
    ...
    string PAMI\Message\Event\SCCPAttachedDeviceEntryEvent::getCfwdNumber()
