PAMI\Message\Event\SCCPDeviceServiceURLEntryEvent
===============

Event triggered by SCCPShowDevice ServiceURL Entries.

PHP Version 5


* Class name: SCCPDeviceServiceURLEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPDeviceServiceURLEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPDeviceServiceURLEntryEvent::getChannelObjectType()
...
### getId
    ...
    integer PAMI\Message\Event\SCCPDeviceServiceURLEntryEvent::getId()
...
### getURL
    ...
    string PAMI\Message\Event\SCCPDeviceServiceURLEntryEvent::getURL()
