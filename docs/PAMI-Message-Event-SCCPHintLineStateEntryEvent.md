PAMI\Message\Event\SCCPHintLineStateEntryEvent
===============
...
* Class name: SCCPHintLineStateEntryEvent
...
### getChannelType
    ...
    string PAMI\Message\Event\SCCPHintLineStateEntryEvent::getChannelType()
...
### getChannelObjectType
    ...
    string PAMI\Message\Event\SCCPHintLineStateEntryEvent::getChannelObjectType()
...
### getLineName
    ...
    string PAMI\Message\Event\SCCPHintLineStateEntryEvent::getLineName()
...
### getState
    ...
    string PAMI\Message\Event\SCCPHintLineStateEntryEvent::getState()
...
### getCallInfoNumber
    ...
    string PAMI\Message\Event\SCCPHintLineStateEntryEvent::getCallInfoNumber()
...
### getCallInfoName
    ...
    string PAMI\Message\Event\SCCPHintLineStateEntryEvent::getCallInfoName()
...
### getDirection
    ...
    string PAMI\Message\Event\SCCPHintLineStateEntryEvent::getDirection()
