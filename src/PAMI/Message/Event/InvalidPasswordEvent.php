 ...
 */
class InvalidPasswordEvent extends EventMessage
{
    /**
     * get EventTV
     *
     ...
     * @return string
     */
    public function getReceivedChallenge()
    {
        return $this->getKey('ReceivedChallenge');
    }
     ...
     * @return string
     */
    public function getReceivedHash()
    {
