 ...
 * Note: Auto Generated using xsltproc
 */
class PRIDebugSetAction extends ActionMessage
{
    /**
     * Constructor.
     *
     ...
     * @return void
     */
    public function __construct($span, $level)
    {
        parent::__construct('PRIDebugSet');
        $this->setKey('Span', $span);
        $this->setKey('Level', $level);
    }
}
