<?php
/**
 * PJSIPUnregister action message.
 *
 * PHP Version 5
 *
 * @category   Pami
 ...
 * @link       http://marcelog.github.com/PAMI/
 */
class PJSIPUnregisterAction extends ActionMessage
{
    /**
     * Constructor.
     *
     * @param string $registration The outbound registration to unregister
     *
     * @return void
     */
    public function __construct($registration)
    {
        parent::__construct('PJSIPUnregister');
