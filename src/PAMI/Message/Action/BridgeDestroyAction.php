 ...
 * - @see PAMI\Message\Action\BridgeKickAction
 * - @see PAMI\Message\Action\BridgeListAction
 * - @see PAMI\Message\Event\BridgeDestroyEvent
 *
 * Note: Auto Generated using xsltproc
 */
class BridgeDestroyAction extends ActionMessage
{
    /**
     * Constructor.
     *
    ...
    {
        parent::__construct('BridgeDestroy');
