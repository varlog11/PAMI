 ...
 * @link       http://marcelog.github.com/PAMI/
 */
class PJSIPRegisterAction extends ActionMessage
{
    /**
     * Constructor.
     *
     * @param string $registration The outbound registration to register
     *
     * @return void
     */
    public function __construct($registration)
    {
        parent::__construct('PJSIPRegister');
