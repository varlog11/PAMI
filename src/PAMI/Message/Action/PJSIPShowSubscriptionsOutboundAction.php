<?php
/**
 * PJSIPShowSubscriptionsOutbound action message.
 *
 * PHP Version 5
 *
 * @category   Pami
 ...
 * @link       http://marcelog.github.com/PAMI/
 */
class PJSIPShowSubscriptionsOutboundAction extends ActionMessage
{
    /**
     * Constructor.
     *
    ...
    {
        parent::__construct('PJSIPShowSubscriptionsOutbound');
